...
const QuizCard = ({ 
  ...
  return (
    <div className="bg-white rounded-lg m-5 p-6 shadow">
      ...
      <button 
        className="bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-blue-300 dark:focus:ring-blue-800 text-white border-none rounded-full py-3 px-6 text-base cursor-pointer w-full mt-6"
        onClick={onSubmit}
      >
        Submit question
      </button>
